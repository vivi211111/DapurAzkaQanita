  ...
  return (
    ...
    >
      <div className="pt-16">
            ...
            <div className="grid grid-cols-2 gap-4 mb-10">
              {policies.map((policy, index) => (
                ...
                >
                  ...
                  <h3 className="font-serif text-xl font-semibold text-batik-brown dark:text-batik-gold mb-1">
                    {policy.title}
                  </h3>
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-300">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4">
                    ...
                    <li>
                      Pengembalian dapat dilakukan dalam 7 hari setelah
                      penerimaan
                    </li>
                    <li>
        ...
        {/* Return Policy */}
        {/* MOBILE: block md:hidden, compact, font kecil, padding kecil, grid lebih rapat */}
        <section className="py-8 bg-batik-cream/30 block md:hidden">
          <div className="max-w-4xl mx-auto px-2">
            <div className="bg-white rounded-lg shadow p-3 border border-gray-100">
              <div className="flex items-center mb-3">
                <Scale className="text-batik-gold mr-2" size={20} />
              ...
              <div className="space-y-4 text-gray-600 text-xs">
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <div className="bg-green-50 p-2 rounded">
                      <h4 className="font-semibold text-green-800 mb-1 text-xs">
                        ✓ Dapat Dikembalikan
                      </h4>
                    ...
                    <div className="bg-red-50 p-2 rounded">
                      <h4 className="font-semibold text-red-800 mb-1 text-xs">
                ...
                <div>
                  ...
                  <ol className="list-decimal list-inside space-y-1 ml-3">
                    ...
                    <li>Tunggu konfirmasi dan nomor RMA</li>
                    <li>Kemas produk dan kirim ke alamat yang ditentukan</li>
                    <li>Refund diproses 7-14 hari kerja setelah produk diterima</li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-3">
                    <li>Gratis jika produk cacat/salah kirim</li>
                    <li>Ditanggung pembeli jika alasan pribadi</li>
                    <li>Asuransi return wajib untuk produk &gt; Rp1.000.000</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        {/* Data Security */}
        {/* MOBILE: block md:hidden, compact, font kecil, icon kecil, grid rapat, padding kecil */}
        <section className="py-8 bg-white block md:hidden">
          <div className="max-w-4xl mx-auto px-2">
            <div className="bg-white rounded-lg shadow p-3 border border-gray-100">
              <div className="flex items-center mb-3">
                <Lock className="text-batik-gold mr-2" size={20} />
              ...
              <div className="space-y-4 text-gray-600 text-xs">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-3">
                    <li>Tidak menyimpan info kartu kredit di server kami</li>
